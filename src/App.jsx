...
function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 hover:shadow-xl sm:h-16 sm:w-16"
...
function ScrollToHash() {
  ...
  useEffect(() => {
    ...
    } else if (!pathname.startsWith('/properties/') && !pathname.startsWith('/biens/')) {
      window.scrollTo(0, 0)
    }
  }, [pathname, hash])
    ...
    <>
      ...
      <main>
        <Routes>
          ...
          <Route path="/biens/:slug" element={<PropertyDetailPage />} />
        </Routes>
      </main>
      <Footer />
      <WhatsAppFloat />
